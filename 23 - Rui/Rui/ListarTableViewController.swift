...
class ListarTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        lista.append("Francisco")
        lista.append("Rafael")
        lista.append("VICENTE")
        lista.append("João")
        lista.append("Nícolas")
        lista.append("Mariana")
        lista.append("André")
        lista.append("Aparecida")
    }
    ...
    override func tableView(_ tableView: UITableView, moveRowAt fromIndexPath: IndexPath, to: IndexPath) {
        let aux = self.lista[fromIndexPath.row]
        self.lista[fromIndexPath.row] = self.lista[to.row]
        self.lista[to.row] = aux
    }
